...
export const APPS: App[] = [
  ...
  },
  {
    ...
    faqs: [
      ...
      { q: 'Is there a profile cap?', a: 'No. The ₹399/month cloud plan ships with unlimited member profiles and unlimited admin users. We never throttle the catalogue you have built.' },
      { q: 'Can you tailor the verification flow for our community?', a: 'Yes. Community-specific customisations — a custom KYC step, profile fields tuned to your members — are handled as a self-hosted or enterprise engagement. Scope it with us at hello@shabuilds.tech.' },
  ...
  },
  {
    ...
    faqs: [
      { q: 'Can I customise the portal for my industry vocabulary?', a: 'Yes. Job categories, skills, taxonomies, application forms, employer fields and emails are all configurable per portal. Deeper customisations — a niche screening flow or an industry-specific candidate score — are handled as a self-hosted or enterprise engagement.' },
