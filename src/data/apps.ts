...
export const APPS: App[] = [
  {
    ...
    pricing: [
      { plan: 'Starter', audience: 'B2B / B2C', cloud: { yearly: '₹3,999/year', note: '1 user, unlimited invoices' }, selfHost: { yearly: '₹9,999/year', note: 'Single-server licence' } },
      { plan: 'Growth', audience: 'B2B', cloud: { yearly: '₹9,999/year', note: '5 users, multi-branch' }, selfHost: { yearly: '₹19,999/year', note: 'Single-server, 5 users' } },
      { plan: 'Scale', audience: 'B2B', cloud: { yearly: 'Talk to us', note: 'Unlimited users, SSO' }, selfHost: { yearly: 'Talk to us', note: 'Source access + support' } },
    ],
    faqs: [
  ...
  },
  {
    ...
    pricing: [
      { plan: 'Starter', audience: 'B2B / B2C', cloud: { yearly: '₹3,999/year', note: '1 warehouse, 1 user' }, selfHost: { yearly: '₹9,999/year', note: 'Single-server licence' } },
      { plan: 'Growth', audience: 'B2B', cloud: { yearly: '₹9,999/year', note: '3 warehouses, 5 users' }, selfHost: { yearly: '₹19,999/year', note: 'Single-server, 5 users' } },
      { plan: 'Scale', audience: 'B2B', cloud: { yearly: 'Talk to us', note: 'Unlimited locations' }, selfHost: { yearly: 'Talk to us', note: 'Source access + support' } },
    ],
    faqs: [
  ...
  },
  {
    ...
    features: [
      ...
      { title: 'Bundle pricing', body: 'About 30% cheaper than buying both separately — same product, less invoice clutter.' },
    ...
    pricing: [
      { plan: 'Bundle Starter', audience: 'B2B / B2C', cloud: { yearly: '₹5,999/year', note: '1 user, 1 warehouse' }, selfHost: { yearly: '₹14,999/year', note: 'Single-server licence' } },
      { plan: 'Bundle Growth', audience: 'B2B', cloud: { yearly: '₹14,999/year', note: '5 users, 3 warehouses' }, selfHost: { yearly: '₹29,999/year', note: 'Single-server, 5 users' } },
      { plan: 'Bundle Scale', audience: 'B2B', cloud: { yearly: 'Talk to us', note: 'Unlimited users + SSO' }, selfHost: { yearly: 'Talk to us', note: 'Source access + support' } },
    ],
    faqs: [
      { q: 'How much do I save with the bundle?', a: 'About 30% versus buying Nidhi Books and Nidhi Inventory separately, on both cloud and self-hosted plans.' },
      { q: 'Can I start with one app and add the other later?', a: 'Yes. You can begin with either product and upgrade to the bundle at any time — your data and users migrate automatically.' },
  ...
  },
  {
    ...
    pricing: [
      { plan: 'Launch', audience: 'B2C', cloud: { yearly: '₹19,999/year', note: 'Up to 5,000 profiles' }, selfHost: { yearly: '₹49,999/year', note: 'Single-server licence' } },
      { plan: 'Grow', audience: 'B2C', cloud: { yearly: '₹49,999/year', note: 'Up to 50,000 profiles' }, selfHost: { yearly: '₹99,999/year', note: 'Single-server, full features' } },
      { plan: 'Enterprise', audience: 'B2B', cloud: { yearly: 'Talk to us', note: 'Unlimited + custom' }, selfHost: { yearly: 'Talk to us', note: 'Source access + support' } },
    ],
    faqs: [
  ...
  },
  {
    ...
    pricing: [
      { plan: 'Launch', audience: 'B2C', cloud: { yearly: '₹19,999/year', note: 'Up to 1,000 active jobs' }, selfHost: { yearly: '₹49,999/year', note: 'Single-server licence' } },
      { plan: 'Grow', audience: 'B2C', cloud: { yearly: '₹49,999/year', note: 'Up to 10,000 active jobs' }, selfHost: { yearly: '₹99,999/year', note: 'Single-server, full features' } },
      { plan: 'Enterprise', audience: 'B2B', cloud: { yearly: 'Talk to us', note: 'Unlimited + SSO' }, selfHost: { yearly: 'Talk to us', note: 'Source access + support' } },
    ],
    faqs: [
      { q: 'Can I customise the portal for my industry vocabulary?', a: 'Yes. Job categories, skills, taxonomies, application forms, employer fields and emails are all configurable per portal.' },
